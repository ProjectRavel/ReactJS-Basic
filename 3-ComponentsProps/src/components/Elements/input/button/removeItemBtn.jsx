const RemoveitemBtn = ({variant = "slate", name = "Test", onClick, type="button"}) => {
    ...
    return (
        <button 
          type={type}
          className={`text-white ${classes.base} font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none transition-all duration-300 active:opacity-75`}
          onClick={onClick}
        >
          {name}
        </button>
