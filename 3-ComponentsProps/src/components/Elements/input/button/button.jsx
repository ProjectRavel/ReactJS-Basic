const Button = (props) => {
    const { variant = "slate", name = "Test" } = props;
    
    // Define a mapping for variants to classes
    ...
    return (
      <div>
        <button
          type="button"
          className={`text-white ${classes.base} font-medium rounded-lg text-sm px-5 py-2.5 me-2 w-full mb-2 focus:outline-none transition-all duration-300`}
        >
          {name}
        </button>
      </div>
